...
// This is useless when panics would NEVER unwind due to -C panic=abort and when we don't care about Rust
...
// See https://github.com/rust-lang/rust/pull/112403 and https://github.com/rust-lang/rust/pull/143613.
